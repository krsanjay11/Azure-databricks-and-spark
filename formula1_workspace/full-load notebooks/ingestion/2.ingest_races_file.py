...
races_selected_df = races_with_timestamp_df.select(col('raceId').alias("race_id"), col('year').alias("race_year"), col('circuitId').alias("circuit_id"), col('round'), col('name'), col('race_timestamp'), col('data_source'), col('ingestion_date'))
